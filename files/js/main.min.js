...
function navHandler() {
	...
	document.addEventListener('wheel', (e) => {
		...
		if (!timeout) {
			...
			if (!isDown) {
				newPosition = ((index+1) == locations.length) ? locations[0] : locations[index+1];
			} else {
				newPosition = (index == 0) ? locations[(locations.length-1)] : locations[index-1];
			}

			$("body").data("position", newPosition.name);
